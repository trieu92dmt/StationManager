...
{
    public static class ISDDateTimeFormat
    {
        public const string FullDateTimeTT = "dd/MM/yyyy HH:mm:ss tt";
        public const string FullDateTime = "dd/MM/yyyy HH:mm:ssZ";
        ...
        public const string MonthOnly = "MM";
        public const string YearOnly = "yy";
    }
