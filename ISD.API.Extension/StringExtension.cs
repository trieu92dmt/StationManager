...
namespace ISD.API.Extension
{
    ...
    public static class StringExtensions
    {
        ...
        // 202203 =>> 2022 , 03
        public static List<int> GetYearMonthFromString(this string input)
        {
            var lst = new List<int>();
            lst.Add(Int32.Parse(input.Substring(0, 3))); // year
            lst.Add(Int32.Parse(input.Substring(input.Length - 2))); // month
            return lst;
        }
    }
}
