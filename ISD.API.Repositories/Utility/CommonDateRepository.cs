...
{
    public interface ICommonDateRepository
    {
    ...
    public class CommonDateRepository : GenericRepository<DimDateModel>, ICommonDateRepository
    {
        ...
        public CommonDateRepository(EntityDataContext _context) : base(_context)
        {
