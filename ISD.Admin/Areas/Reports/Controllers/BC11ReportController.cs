...
{
    public class BC11ReportController : BaseController
    {
        // GET: SO100Report
        [ISDAuthorizationAttribute]
        public ActionResult Index()
        {
            var searchModel = (BC11ReportViewModel)TempData[CurrentUser.AccountId + "BC11ReportSearchData"];
            var tempalteIdString = TempData[CurrentUser.AccountId + "BC11ReportTemplateId"];
            var modeSearch = TempData[CurrentUser.AccountId + "BC11ReportModeSearch"];
            //mode search
            ...
            var pageId = GetPageId("/Reports/BC11Report");
            // search data
        ...
        public ActionResult ViewDetail(BC11ReportViewModel searchModel, Guid pivotTemplate, string modeSearch)
        {
            TempData[CurrentUser.AccountId + "BC11ReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "BC11ReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "BC11ReportModeSearch"] = modeSearch;
            return RedirectToAction("Index");
        }

        public ActionResult ChangeTemplate(Guid pivotTemplate, BC11ReportViewModel searchModel, string modeSearch)
        {
            TempData[CurrentUser.AccountId + "BC11ReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "BC11ReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "BC11ReportModeSearch"] = modeSearch;
        ...
        [ValidateInput(false)]
        public ActionResult BC11ReportPivotGridPartial(Guid? templateId = null, BC11ReportViewModel searchViewModel = null, string jsonReq = null)
        {
            #region commonDate
            ...
            {
                ViewBag.Search = null;
                return PartialView("_BC11PivotGridPartial", null);
            }
            else
            {
                if (!string.IsNullOrEmpty(jsonReq))
                {
                    searchViewModel = JsonConvert.DeserializeObject<BC11ReportViewModel>(jsonReq);
                  

                }
                var model = _unitOfWork.BC11ReportRepository.GetData(searchViewModel);
                ViewBag.Search = searchViewModel;
                return PartialView("_BC11PivotGridPartial", model);
            }
        }

        [HttpPost]
        public ActionResult ExportPivot(BC11ReportViewModel searchViewModel, Guid? templateId)
        {
