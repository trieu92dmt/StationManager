...
{
    public class BC18_1ReportController : BaseController
    {
        // GET: SO100Report
        [ISDAuthorizationAttribute]
        public ActionResult Index()
        {
            var searchModel = (BC18_1ReportViewModel)TempData[CurrentUser.AccountId + "BC18_1ReportSearchData"];
            var tempalteIdString = TempData[CurrentUser.AccountId + "BC18_1ReportTemplateId"];
            var modeSearch = TempData[CurrentUser.AccountId + "BC18_1ReportModeSearch"];
            //mode search
            ...
            var pageId = GetPageId("/Reports/BC18_1Report");
            // search data
        ...
        public ActionResult ViewDetail(BC18_1ReportViewModel searchModel, Guid pivotTemplate, string modeSearch)
        {
            TempData[CurrentUser.AccountId + "BC18_1ReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "BC18_1ReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "BC18_1ReportModeSearch"] = modeSearch;
            return RedirectToAction("Index");
        }

        public ActionResult ChangeTemplate(Guid pivotTemplate, BC18_1ReportViewModel searchModel, string modeSearch)
        {
            TempData[CurrentUser.AccountId + "BC18_1ReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "BC18_1ReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "BC18_1ReportModeSearch"] = modeSearch;
        ...
        [ValidateInput(false)]
        public ActionResult BC18_1ReportPivotGridPartial(Guid? templateId = null, BC18_1ReportViewModel searchViewModel = null, string jsonReq = null)
        {
            #region commonDate
            ...
            {
                ViewBag.Search = null;
                return PartialView("_BC18_1PivotGridPartial", null);
            }
            else
            {
                if (!string.IsNullOrEmpty(jsonReq))
                {
                    searchViewModel = JsonConvert.DeserializeObject<BC18_1ReportViewModel>(jsonReq);
                  

                }
                var model = _unitOfWork.BC18ReportRepository.GetData_2(searchViewModel);
                ViewBag.Search = searchViewModel;
                return PartialView("_BC18_1PivotGridPartial", model);
            }
        }

        [HttpPost]
        public ActionResult ExportPivot(BC18_1ReportViewModel searchViewModel, Guid? templateId)
        {
