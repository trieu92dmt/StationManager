...
{
    public class BC18_2ReportController : BaseController
    {
        // GET: SO100Report
        [ISDAuthorizationAttribute]
        public ActionResult Index()
        {
            var searchModel = (BC18_2ReportViewModel)TempData[CurrentUser.AccountId + "BC18_2ReportSearchData"];
            var tempalteIdString = TempData[CurrentUser.AccountId + "BC18_2ReportTemplateId"];
            var modeSearch = TempData[CurrentUser.AccountId + "BC18_2ReportModeSearch"];
            //mode search
            ...
            var pageId = GetPageId("/Reports/BC18_2Report");
            // search data
        ...
        public ActionResult ViewDetail(BC18_2ReportViewModel searchModel, Guid pivotTemplate, string modeSearch)
        {
            TempData[CurrentUser.AccountId + "BC18_2ReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "BC18_2ReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "BC18_2ReportModeSearch"] = modeSearch;
            return RedirectToAction("Index");
        }

        public ActionResult ChangeTemplate(Guid pivotTemplate, BC18_2ReportViewModel searchModel, string modeSearch)
        {
            TempData[CurrentUser.AccountId + "BC18_2ReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "BC18_2ReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "BC18_2ReportModeSearch"] = modeSearch;
        ...
        [ValidateInput(false)]
        public ActionResult BC18_2ReportPivotGridPartial(Guid? templateId = null, BC18_2ReportViewModel searchViewModel = null, string jsonReq = null)
        {
            #region commonDate
            ...
            {
                ViewBag.Search = null;
                return PartialView("_BC18_2PivotGridPartial", null);
            }
            else
            {
                if (!string.IsNullOrEmpty(jsonReq))
                {
                    searchViewModel = JsonConvert.DeserializeObject<BC18_2ReportViewModel>(jsonReq);
                  

                }
                var model = _unitOfWork.BC18ReportRepository.GetData(searchViewModel);
                ViewBag.Search = searchViewModel;
                return PartialView("_BC18_2PivotGridPartial", model);
            }
        }

        [HttpPost]
        public ActionResult ExportPivot(BC18_2ReportViewModel searchViewModel, Guid? templateId)
        {
