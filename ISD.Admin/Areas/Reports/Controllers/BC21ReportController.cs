...
{
    public class BC21ReportController : BaseController
    {
        // GET: BC21Report
        ...
        public ActionResult Index()
        {
            ...
            BC21ReportViewModel viewModel = new BC21ReportViewModel();
            viewModel.ReportDate = currentDate;
            CreateViewBag();
            return View(viewModel);
        }

        public ActionResult ViewReport(BC21ReportViewModel viewModel)
        {
            ...
            //return PartialView("_BC21ReportPartial");
            return View(viewModel);
        }

        public ActionResult GetData(BC21ReportViewModel viewModel)
        {
            var currentDate = DateTime.Now;
            //Nếu field ngày không nhập giá trị hoặc chọn xem theo ngày hiện tại thì lấy ngày hiện tại
            if (!viewModel.ReportDate.HasValue || viewModel.IsViewAtCurrent == true)
            ...
            var result = _unitOfWork.BC21ReportRepository.GetData(viewModel, out error);
