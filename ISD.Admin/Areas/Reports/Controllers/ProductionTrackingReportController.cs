...
{
    public class ProductionTrackingReportController : BaseController
    {
        // GET: SO100Report
        [ISDAuthorizationAttribute]
        public ActionResult Index()
        {
            var searchModel = (ProductionCompletedStagesReportViewModel)TempData[CurrentUser.AccountId + "ProductionTrackingReportSearchData"];
            var tempalteIdString = TempData[CurrentUser.AccountId + "ProductionTrackingReportTemplateId"];
            var modeSearch = TempData[CurrentUser.AccountId + "ProductionTrackingReportModeSearch"];
            //mode search
            ...
            var pageId = GetPageId("/Reports/ProductionTrackingReport");
            // search data
        ...
        {
            TempData[CurrentUser.AccountId + "ProductionTrackingReportSearchData"] = searchModel;
            TempData[CurrentUser.AccountId + "ProductionTrackingReportTemplateId"] = pivotTemplate;
            TempData[CurrentUser.AccountId + "ProductionTrackingReportModeSearch"] = modeSearch;
        ...
        [ValidateInput(false)]
        public ActionResult ProductionTrackingReportPivotGridPartial(Guid? templateId = null, ProductionCompletedStagesReportViewModel searchViewModel = null, string jsonReq = null)
        {
            #region commonDate
            ...
            {
                ViewBag.Search = null;
                return PartialView("_ProductionTrackingPivotGridPartial", null);
            }
            else
            {
                ...
                return PartialView("_ProductionTrackingPivotGridPartial", model);
            }
        }
    }
}