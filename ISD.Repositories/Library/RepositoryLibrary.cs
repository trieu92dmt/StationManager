...
namespace ISD.Repositories
{
    public class RepositoryLibrary
    {
        ...
        public string EncodePassword(string source, string password = "")
        {
            ...
            {
                password = "XJenBr2oWxP7UdBRSkyIo1mqB4O6UBs3";
            }
        ...
        public string DecodePassword(string source, string password = "")
        {
        ...
        public string EncryptString(string stringToEncrypt)
        {
            ...
            aesCipher.Key = Encoding.ASCII.GetBytes("XJenBr2oWxP7UdBRSkyIo1mqB4O6UBs3");
