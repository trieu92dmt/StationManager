...
{
    [Table("InhouseTransferModel", Schema = "DataCollection")]
    public partial class InhouseTransferModel
    {
        [Key]
        public Guid InhouseTransferId { get; set; }
        ...
        [InverseProperty("InhouseTransferModel")]
