...
{
    [Table("ReceiptFromProductionModel", Schema = "DataCollection")]
    public partial class ReceiptFromProductionModel
    {
        [Key]
        public Guid RcFromProductiontId { get; set; }
        ...
        [InverseProperty("ReceiptFromProductionModel")]
